...
"..\..\deps\llvm\build\Debug\bin\lld-link.exe" -nologo -dll -force:multiple -ignore:4042 -ignore:4049,4217 -def:".\libobjc.def" -out:".\Debug\libobjc.A.dll" -debug "libcmt.lib" "..\..\Debug\pthread\pthread.lib" @".\Debug\files.txt" %*
