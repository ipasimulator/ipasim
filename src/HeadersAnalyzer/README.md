...
Even if we realized that this inconsistency isn't a problem, this would still be a good approach to emulating the iOS system `.dylib`s in order for the emulated app not to recognize it's emulated.
