...
} API_AVAILABLE(ios(11.0)) __TVOS_UNAVAILABLE NS_SWIFT_NAME(UIDocumentBrowserAction.Availability);
...
API_AVAILABLE(ios(11.0)) __TVOS_UNAVAILABLE @interface UIDocumentBrowserAction : NSObject
