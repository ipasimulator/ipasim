...
// ..\..\build\bin\clang -target i386-pc-windows-msvc main.mm -o build/main.exe -fobjc-runtime=ios-11 -g -gcodeview -fuse-ld=..\..\build\bin\lld-link -L "..\..\src\objc\Debug" -L "..\..\Debug" -L ".\build" -llibobjc.A -ltestclass -ldyld -Wl,-debug -I "..\..\deps\llvm\include" -I "..\..\deps\llvm\build\include"

// To get .obj:
// ..\..\build\bin\clang -target i386-pc-windows-msvc -c main.mm -o build/main-obj.obj -fobjc-runtime=ios-11 -g -gcodeview -I "..\..\deps\llvm\include" -I "..\..\deps\llvm\build\include"
